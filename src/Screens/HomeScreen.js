...
import { StyleSheet, Text, View, Image, TouchableOpacity, FlatList,Dimensions, Alert, BackHandler } from 'react-native'
const HomeScreen = () => {
  ...
  const data = [
    {
      id: 1,
      name: 'Hindi',
      image: require("../Images/hindi.png"), // Local image ,
      count: 124.711,
    },
    {
      id: 2,
...
const styles = StyleSheet.create({
  ...
  name: {
    marginTop: '11%',         // Adjust based on your preference
    fontSize: width * 0.06, // Adjust based on your preference
    flex: 1,
    alignSelf: 'center',
    color: '#3399ff',
    fontWeight: 'bold',
    marginLeft: '2%',        // Adjust based on your preference
  },
  count: {
    fontSize: 14,
    flex: 1,
